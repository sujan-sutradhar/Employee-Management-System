...
const CreateTask = () => {
  return (
    <div><h1 className="text-4xl font-semibold mb-6 text-center">Admin Panel</h1>
        ...
        <form action="" className="grid grid-cols-2 gap-8">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="flex justify-end mt-4">
              <button 
                type="submit" 
                className="bg-blue-600 w-full  text-white  rounded-md hover:bg-blue-700 transition-all text-2xl font-semibold"
              >
                Create Task
              </button>
            </div>
